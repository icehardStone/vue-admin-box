...
const nursing = {
  ...
  view: createNameComponent(() => import('@/views/provided/nursing/view.vue')),
  add: createNameComponent(() => import('@/views/provided/nursing/index.vue')),
  edit: createNameComponent(() => import('@/views/provided/nursing/index.vue')),
