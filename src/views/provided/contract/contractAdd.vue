                ...
                <el-form :model="form" label-position="right" label-width="auto">
                 ...
                 <el-card class="record-add-body-item">
                        ...
                        <el-form-item label="健康情况">
                                ...
                                <el-radio value="Promotion activities" name="type">
                                    生活半自理
                                </el-radio>
                                <el-radio value="Offline activities" name="type">
                                    生活不能自理
                                </el-radio>

                            </el-radio-group>
                        </el-form-item>
                        <el-form-item label="第三方评估" style="width: 18rem;">
                            <el-input v-model="form.user" placeholder="第三方评估" clearable />
                        </el-form-item>
                        <el-form-item label="入院理由" style="width: 23rem;">
                                     <el-radio-group v-model="form.type">
                                <el-radio value="Online activities" name="type">
                                    无人照顾
                                </el-radio>
                        ...
                        <el-form-item label="希望入住区域" style="width: 23rem;">
                            <el-input v-model="form.user" placeholder="希望入住区域" clearable />
                        </el-form-item>
                        <el-form-item label="床位条件" style="width: 23rem;">
                            <el-input v-model="form.user" placeholder="床位条件" clearable />
                        </el-form-item>
                        <el-form-item label="护理条件" style="width: 23rem;">
                            <el-input v-model="form.user" placeholder="护理条件" clearable />
                        </el-form-item>
                        <el-form-item label="禁忌药品">
                            <el-input type="textarea" v-model="form.user" placeholder="禁忌药品" clearable />
                        </el-form-item>
                    ...
                    <el-card class="record-add-body-item">
                        ...
                        <el-form-item label="预约状态" >
                             <el-radio-group v-model="form.type">
                                ...
                                <el-radio value="Simple brand exposure" name="type">
                                    放弃
                                </el-radio>
                                <el-radio value="Simple brand exposure" name="type">
                                    失联
                        ...
                        <el-form-item label="预约状态说明">
                            <el-input type="textarea" v-model="form.user" placeholder="预约状态说明" clearable />
                        </el-form-item>
                        <el-form-item label="备注">
