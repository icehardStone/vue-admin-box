  ...
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      <Table ref="table" v-model:page="page" v-loading="loading" :showIndex="true" :showSelection="true"
        ...
        <el-table-column prop="name" label="设备ID" align="center" />
        <el-table-column prop="radioName" label="设备名称" align="center" />
        <el-table-column prop="radioName" label="设备编号" align="center" />
        <el-table-column prop="radioName" label="设备昵称" align="center" />
        <el-table-column prop="radioName" label="序列号" align="center" />
        <el-table-column prop="radioName" label="在线状态" align="center" />
        <el-table-column prop="radioName" label="电量" align="center" />
        <el-table-column prop="radioName" label="放置区域" align="center" />
        <el-table-column prop="radioName" label="分配老人" align="center" />
        <el-table-column prop="radioName" label="入库时间" align="center" />
        <el-table-column prop="radioName" label="最新上线时间" align="center" />
        <el-table-column prop="radioName" label="分配状态" align="center" />
