<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <el-table-column prop="name" label="收费项名称" align="center" />
        <el-table-column prop="number" label="规则" align="center" />
        <el-table-column prop="chooseName" label="单价" align="center" />
        <el-table-column prop="radioName" label="费用分类" align="center" />
        <el-table-column prop="radioName" label="状态" align="center" />
        <el-table-column prop="radioName" label="创建时间" align="center" />
